...
function Login() {
  ...
  return (
    <form className="flex flex-col px-[10%] md:px-0 md:mt-[10%] md:ml-[10%] mb-[26%]">
      ...
      />
      <Link to="/forgotpwd" className="mb-14 font-bold text-xl text-secondary">
        Forgot Password?
      </Link>
      <button
        type="submit"
      ...
      >
        <img src={logoGoogle} alt="" className="w-6 md:w-7" /> Login with Google
      </button>
    </form>
  );
}
...
function Register() {
  return (
    <form className="flex flex-col px-[10%] md:px-0 md:mt-[10%] md:ml-[10%] mb-[26%]">
      ...
      >
        <img src={logoGoogle} alt="" className="w-7" /> Sign Up with Google
      </a>
    </form>
  );
}
