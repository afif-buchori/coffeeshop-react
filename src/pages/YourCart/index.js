    ...
    return (
      <Fragment>
        ...
        <main className="hero-transaction w-full h-auto flex justify-center mt-14 md:mt-28">
          <div className="w-4/5 max-width mb-32 flex flex-col items-center">
            <h1 className="font-bold text-4xl self-start text-white drop-shadow-lg my-14">Checkout your item now!</h1>
            <div className="flex gap-6 md:gap-20 lg:gap-40">
              <div className="flex w-full flex-col p-11 rounded-2xl bg-white">
                <h2 className="font-bold text-3xl mb-16 self-center">Order Summary</h2>
              ...
              <div className="flex w-full flex-col">
                <h3 className="font-bold text-2xl text-white drop-shadow-2xl mb-5">Address details</h3>
                <div className="px-11 py-9 rounded-2xl bg-white mb-10">
                ...
                <h3 className="font-bold text-2xl text-white drop-shadow-2xl mb-5">Payment method</h3>
                <div className="px-11 py-9 rounded-2xl bg-white mb-8">
