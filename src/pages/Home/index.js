...
export class Home extends Component {
  ...
  <section className="hero mt-14 md:mt-28 w-full h-auto flex justify-center ">
    <div className="w-4/5 max-width">
      <form action="" className="h-16 w-auto max-w-xs ml-auto px-8 gap-4 my-5 flex items-center bg-white rounded-[60px]">
        <img src={logoSearch} alt="icon-search" className="w-5" />
        <input type="text" placeholder="Search" className="input-line h-3/4 w-full" />
      </form>
      ...
      <a href="#" className="btn w-full md:w-60 h-14 rounded-2xl bg-primary text-secondary mb-28 md:mb-56">Get Started</a>
    </div>
  </section>
    ...
    <div className="flex flex-col md:flex-row w-full md:gap-[10%]">
      ...
      <div className="flex flex-col md:w-1/2 justify-center">
        ...
        <ul className="text-xs md:text-sm leading-6 md:leading-8">
          ...
          <li className="flex gap-2 md:gap-4"><img src="./img/icon/checklist.svg" alt="" /> Healthy meals, you can request the ingredients</li>
          <li className="flex gap-2 md:gap-4"><img src="./img/icon/checklist.svg" alt="" /> Chat with our staff to get better experience for ordering</li>
          <li className="flex gap-2 md:gap-4"><img src="./img/icon/checklist.svg" alt="" /> Free member card with a minimum purchase of IDR 200.000.</li>
        </ul>
      </div>
    </div>
  </section>
