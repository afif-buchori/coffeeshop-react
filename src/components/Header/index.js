        ...
        <nav className="flex w-full md:w-4/5 mx-4 md:mx-0 max-width">
          ...
          >
            ...
            <Link
              to="/"
              className={
                this.props.title === "home" ? "navlink nav-active" : "navlink"
              }
            >
              Home
            </Link>
          ...
          >
            {this.state.isLogin ? (
              <Account searchValue={this.props.searchValue} />
            ) : (
              <Authentication />
            )}
          ...
          <div
            ...
            className="toggle cursor-pointer flex"
          >
            <img
              src={this.state.toggleActive ? toggleClose : toggleNav}
              alt=""
